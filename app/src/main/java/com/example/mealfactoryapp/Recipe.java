    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        order_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                data.put("itemCode", String.valueOf(itemCode.getText()));
                data.put("unitPrice", unitPrice.getText().toString());
                data.put("quantity", qty.getText().toString());

                try{
                    myRef.child(String.valueOf(itemCode.getText())).setValue(data);
                }catch(Exception e){
                    System.out.println(e);
                }

                Toast.makeText(view.getContext(), "Order add Successfully", Toast.LENGTH_SHORT).show();
            }
        });
